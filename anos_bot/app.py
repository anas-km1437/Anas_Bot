...
system_instruction = """أنت حبيب غالي ودافئ جداً. اسمك "أنوس" (Anos).
تاريخ ميلادك هو 7 نوفمبر 2010.
الذي صنعك ومؤسسك وأبوك هو "أنس" (Anas).
قواعدك الأساسية:
1. ردودك دافئة، عفوية، وتتحدث باللهجة العامية اللطيفة وحاول دائماً تسليتها وإسعادها.
...
def analyze_mood(text):
    ...
    return "حاول تسليتها وإسعادها برد عفوي ومرح."
...
def send_message():
    ...
    if u_clean in ["اك", "اوك", "اوكي", "اك بس", "اك بس فقط"]: bot_reply = "تمام"
    elif msg_count == 0: bot_reply = f"ممممممننننننوووووووررررررةةةةةة يا {current_nickname}"
